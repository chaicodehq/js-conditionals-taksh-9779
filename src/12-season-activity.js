...
export function getSeasonActivity(month, temperature) {
  ...
  if (season == 'Winter' && temperature <0) return {
    season: 'Winter',
    activity: 'skiing'
  }
  ...
  if (season == 'Spring' && temperature > 20) return {
    season: 'Spring',
    activity: 'hiking'
  }
  ...
  if (season == 'Summer' && temperature > 35) return {
    season: 'Summer',
    activity: 'swimming'
  }
  ...
  if (season == 'Autumn' && temperature > 15) return {
    season: 'Autumn',
